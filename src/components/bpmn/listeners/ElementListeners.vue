    ...
    >
      ...
      >
        <el-form-item
          label="字段名称："
          prop="name"
          :rules="{ required: true, trigger: ['blur', 'change'], message: '请输入字段名称' }"
        >
        ...
        <el-form-item
          label="字段类型："
          prop="fieldType"
          :rules="{ required: true, trigger: ['blur', 'change'], message: '请输入字段类型' }"
        >
        ...
        <el-form-item
          ...
          label="字段值："
          prop="string"
          :rules="{ required: true, trigger: ['blur', 'change'], message: '请输入字段值' }"
        >
...
/* 引入element ui 组件 */
import Vue from 'vue'
import { Table, Button, Input, Form, FormItem, Dialog, Select, Option, Divider, Drawer, TableColumn, MessageBox } from 'element-ui'
